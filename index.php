    ...
    <div class="container my-3 "> 
        ...
        <div class="row d-flex justify-content-between">   
            ...
            <div class="col-md-3 "> 
                ...
                <?php
                    $stm = $conn->query("select * from Tasks where `status`= 'todo' order by id desc");
                ?>
                <div class="m-2  py-3">
                    <div class="show-to-do">
                        ...
                        <div class="alert alert-info p-2">
                            <h4 ><?php echo $task['body'] ?></h4>
                            <h5><?php echo $task['created_at'] ?></h5>
                            <div class="d-flex justify-content-between mt-3">
                                <a href="edit.php?id=<?php echo $task['id']?>"class="btn btn-info p-1 text-white" >edit</a>
                                
                                <a href="handle/goto.php?name=doing&id=<?php echo $task['id']?>"class="btn btn-info p-1 text-white" >doing</a>
                            </div>
                        </div>
                        <?php endwhile?>
                    </div>
            ...
            <div class="col-md-3 ">
                ...
                <?php 
                $stm = $conn->query("select * from Tasks where `status`='doing' order by id desc")?>
                ...
                <div class="m-2 py-3">
                    <div class="show-to-do">
                        ...
                        <div class="alert alert-success p-2">
                                ...
                                <div class="d-flex justify-content-between mt-3">
                                    <a></a>
                                    <a href="handle/goto.php?name=done&id=<?php echo $task['id']?>"class="btn btn-success p-1 text-white" >Done</a>
                                </div>
            ...
            <div class="col-md-3">
                ...
                <?php
                $stm = $conn->query("select * from Tasks where `status`='done' order by id desc");?>
                <div class="m-2 py-3">
                    <div class="show-to-do">
                            <?php
                            if($stm->rowCount()<1):
